...
//wifi details and display details 

const char* ssid     = "";                    //WiFi name 
const char* password = "";                    //WiFi password
const char* host = "";                        // hosting site
